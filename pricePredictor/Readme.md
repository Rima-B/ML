The price predictor is a linear regression model to predict cars prices using the [UCI computer science school corpus](https://archive.ics.uci.edu/ml/machine-learning-databases/autos).
